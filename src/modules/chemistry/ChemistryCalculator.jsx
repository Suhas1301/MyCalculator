...
function getEnriched(el) {
  ...
  return {
    ...el, meltingPoint: x.mp, boilingPoint: x.bp, density: x.density, electronegativity: x.en,
  ...
  return (
    ...
    >
      ...
      >
        {/* ── HEADER BANNER ─────────────────────────────────────────── */}
        <div style={{
          background: `linear-gradient(145deg, ${color}18 0%, ${color}06 50%, transparent 100%)`,
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: '20px', flexWrap: 'wrap' }}>
            ...
            <div>
              <div style={{
                fontSize: '5rem', fontWeight: 900, lineHeight: 1, color,
        ...
        <div className="modal-scroll" style={{ flex: '1 1 auto', minHeight: 0, padding: '22px 28px 24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div className="modal-grid">
            ...
            <div style={{
              background: 'rgba(4,6,16,0.7)', border: `1px solid ${color}20`, borderRadius: '14px',
  ...
  return (
    <div className="animate-slide chemistry-scroll" style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '16px', padding: '8px', overflowY: 'auto' }}>
      ...
      <div className="glass-panel" style={{ padding: '20px', background: 'rgba(16,20,35,0.35)', display: 'flex', flexDirection: 'column', gap: '14px' }}>
        ...
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(18, minmax(36px, 1fr))', gridTemplateRows: 'repeat(10, minmax(42px, 1fr))',
          ...
          {elementsData.map((el) => {
            ...
            return (
              <div key={`${el.number}-${el.symbol}`}
                ...
                style={{
                  gridRow: el.period, gridColumn: el.group, borderRadius: '6px',
